...
Desarrollador enfocado en el dominio de múltiples ecosistemas tecnológicos, desde aplicaciones web de alto rendimiento hasta soluciones móviles y arquitecturas de backend escalables.

## 🛠️ Skill Stack
* **Frontend & Mobile:** React, Next.js, Vite, React Native, Swift y Kotlin.
* **Backend:** NestJS, Controller-Service y servicios asíncronos.
* **Infraestructura:** SQL/NoSQL, Azure, AWS y Docker.
---
